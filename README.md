...
821개 블록, 한글 항목 23,468개. 선택지 버튼과 이름 입력 확인 창도 한글이다.

아직 일본어로 남는 것:
- 영어판에서 지워져 PC판에도 없는 일본판 전용 대사 약 140곳(보조 내비 잡담, 몇몇 이벤트의 추가 대사 등)
...
한글 폰트를 한자 칸에 넣었기 때문에 남은 일본어의 한자는 대부분 깨진다. 다만 남는 대사와 기본 이름(星河)에
쓰이는 한자, 목록 화면에 자주 나오는 한자 등 35자는 칸을 비워 두어 그대로 보인다.
...
- [ ] **일본판 전용 대사**(영어판·PC판에 없는 약 140곳) 번역
